...
public class Searcher extends BaseConfig implements AutoCloseable {
	...
	public void BooleanQueries1() {
		...
		TermQuery term1 = new TermQuery(new Term(POLJE_SADRZAJ, "mass")); // bez prefiksa
		TermQuery term2 = new TermQuery(new Term(POLJE_SADRZAJ, "surveillance")); // mora biti prisutan
		TermQuery term3 = new TermQuery(new Term(POLJE_SADRZAJ, "hackers")); // termin se mora iskljuciti
	...
	public void BooleanQueries2() {
		...
		String queryStr = "mass +surveillance -hackers";
